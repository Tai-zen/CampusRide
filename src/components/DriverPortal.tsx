  ...
  return (
    <div id="driver-portal-viewport" className="flex-1 overflow-y-auto px-4 py-6 md:p-8 bg-[#F2F2F2]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 border-b border-gray-100 pb-5">
        <div>
          <span className="text-xs font-bold text-[#175D39] uppercase tracking-widest font-mono">Driver Shift Center</span>
        ...
        <div className="mt-3 sm:mt-0 flex items-center space-x-3.5">
          <button
            ...
            className={`px-4 py-2.5 rounded-xl text-xs font-bold tracking-wide transition flex items-center space-x-2 shadow-sm ${
              shiftOnline 
                ? 'bg-[#175D39] text-white hover:bg-[#175D39]' 
      ...
      <AnimatePresence mode="wait">
        ...
        {activeView === 'driver_dashboard' && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
              <div>
                ...
                <span className="text-2xl font-extrabold text-[#175D39] block">₦{driverProfile.todayEarnings.toFixed(2)}</span>
            ...
            <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
              <div>
                ...
                <span className="text-2xl font-extrabold text-[#175D39] block">{driverProfile.completedTripsCount}</span>
                <span className="text-[9px] text-[#175D39] font-bold bg-[#F2F2F2] px-2 rounded-full inline-block">
                  Target: 20 shifts
                </span>
              </div>
            ...
            <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
              <div>
                ...
                <span className="text-2xl font-extrabold text-[#175D39] block">★ {driverProfile.rating}</span>
                <span className="text-[9px] text-[#175D39] font-bold bg-[#175D39]/10 px-2 rounded-full inline-block">
            ...
            <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
              <div>
                ...
                <span className="text-2xl font-extrabold text-[#175D39] block">{driverProfile.hoursOnline} hrs</span>
                <span className="text-[9px] text-[#175D39] font-bold bg-[#175D39]/10 px-2 rounded-full inline-block">
                  Active duty state
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {activeRide ? (
                <div className="bg-white rounded-3xl border-2 border-primary p-6 shadow-md shadow-lime-50 space-y-6">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <h2 className="text-lg font-extrabold text-[#175D39] mt-2">Active Campus Commuter State</h2>
                      <p className="text-xs text-slate-500">Currently executing verified registrar peer travel itinerary.</p>
                    </div>
                    <span className="bg-[#175D39]/10 text-[#175D39] font-mono font-bold text-[10px] px-2.5 py-1 rounded-lg border border-emerald-250 animate-pulse">
                  ...
                  <div className="bg-[#F2F2F2] p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                    <div className="flex items-center space-x-3.5">
                      ...
                      />
                      <div>
                        <h4 className="text-sm font-bold text-[#175D39]">{activeRide.passengerName}</h4>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-[#175D39]/20 flex items-center justify-center text-[#175D39] shrink-0 text-[10px] font-extrabold">A</div>
                      <div>
                        <span className="text-[9px] font-bold text-gray-400 uppercase font-mono block">Pickup Spot Location</span>
                        <span className="text-xs font-bold text-[#175D39]">{activeRide.pickup}</span>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <span className="text-xs font-bold text-[#175D39]">{activeRide.dropoff}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 p-4 rounded-2xl border border-gray-100 text-xs text-slate-700">
                    <h4 className="font-extrabold text-[#175D39] mb-2 flex items-center">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-primary hover:bg-[#175D39] text-white font-bold rounded-xl text-xs transition flex items-center justify-center space-x-1 shadow-sm"
                    >
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-base font-extrabold text-[#175D39]">Incoming Transit Invitations</h3>
                  ...
                  {!shiftOnline ? (
                    <div className="p-8 text-center bg-gray-50 rounded-2xl border border-gray-100 space-y-2">
                      ...
                      <h4 className="font-bold text-xs text-[#175D39]">Offline Shift Mode Active</h4>
                    ...
                    <div className="bg-[#F2F2F2] rounded-2xl p-5 border border-gray-100 shadow-xs space-y-4">
                      ...
                      <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                        <div className="flex items-center space-x-2.5">
                          ...
                          />
                          <div>
                            <h4 className="text-xs font-bold text-[#175D39]">{incomingRequest.passengerName}</h4>
                            <span className="text-[9px] bg-[#F2F2F2] text-primary px-1.5 py-0.5 rounded font-bold font-mono">★ {incomingRequest.passengerRating} Star Rider</span>
                          </div>
                        </div>

                        <div className="text-right">
                          <span className="text-[9px] font-semibold text-gray-405 block font-mono">ESTIMATED EARNINGS</span>
                          <span className="text-base font-extrabold text-[#175D39]">₦{incomingRequest.cost.toFixed(2)}</span>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-xs">
                        <div className="space-y-1 bg-white p-2.5 rounded-xl border border-gray-100">
                          ...
                          <span className="font-bold text-[#175D39] truncate block">{incomingRequest.pickup}</span>
                        </div>
                        <div className="space-y-1 bg-white p-2.5 rounded-xl border border-gray-100">
                          <span className="text-[9px] font-bold text-gray-400 font-mono block tracking-wider uppercase">Destination Stop</span>
                          <span className="font-bold text-[#175D39] truncate block">{incomingRequest.dropoff}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex space-x-2 pt-2 border-t border-gray-100">
                        <button
                          ...
                          className="flex-1 py-2.5 bg-[#175D39] hover:bg-[#175D39] text-white font-bold rounded-xl text-xs transition flex items-center justify-center space-x-1 shadow-md shadow-emerald-50"
                        >
            ...
            <div className="lg:col-span-4 bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-4">
              <h3 className="text-sm font-extrabold text-[#175D39] flex items-center">
                <Award className="w-4 h-4 text-[#175D39] mr-1.5" />
                Shift Advisor Guidelines
              </h3>

              <div className="space-y-3.5 text-xs text-slate-600 leading-relaxed">
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                  <span className="font-bold text-[#175D39] block mb-1">Registrar ID Checks</span>
                ...
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                  <span className="font-bold text-[#175D39] block mb-1">Peak Hours Commutes</span>
        ...
        {activeView === 'driver_earnings' && (
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 pb-4">
              <div>
                <h3 className="text-lg font-extrabold text-[#175D39]">Shift Performance & Earnings</h3>
                <p className="text-xs text-gray-450 font-medium">Breakdown of credits reloads, carpool clean-energy incentives, and tips.</p>
              </div>

              <div className="bg-[#F2F2F2] text-[#175D39] border border-[#175D39]/30 px-4 py-2 rounded-xl text-xs font-bold leading-normal">
            ...
            <div className="h-64 bg-slate-900 rounded-2xl overflow-hidden relative p-6 flex flex-col justify-between text-white">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs bg-[#175D39] text-white font-bold px-3 py-1 rounded-full">+12.5% vs Last Week</span>
              </div>
              ...
              <div className="flex items-end justify-between h-32 gap-3 pt-4">
                {[
                  ...
                  <div key={id} className="flex-1 flex flex-col items-center group cursor-pointer">
                    ...
                    <div 
                      className="w-full bg-[#175D39] rounded-t-md transition-all group-hover:bg-amber-400 shadow-sm shadow-amber-900/10" 
        ...
        {activeView === 'driver_settings' && (
          ...
          >
          <div>
            <h2 className="text-lg font-extrabold text-[#175D39]">Vehicle profile registries</h2>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl bg-[#F2F2F2] text-[#175D39] flex items-center justify-center">
                  <Car className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider font-mono">PRIMARY VEHICLE FILE</span>
                  <h4 className="text-sm font-bold text-[#175D39]">Toyota Camry 2.5 Hybrid (Silver)</h4>
                  <p className="text-xs font-mono text-gray-500">License Plate Tag: 4P-928X • Decal VERIFIED</p>
                </div>
              </div>
              <span className="bg-[#175D39]/10 text-[#175D39] text-[10px] font-bold px-2.5 py-1 rounded border border-emerald-250 font-mono">
                ACTIVE
              </span>
            </div>
            ...
            <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100 flex items-center justify-between opacity-60">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-xl bg-[#175D39]/10 text-orange-650 flex items-center justify-center">
                  <Car className="w-6 h-6" />
                </div>
                <div>
              ...
              <button 
                ...
                className="text-xs text-[#175D39] font-bold hover:underline"
              >
                Set Active
              </button>
            </div>
          ...
          <div className="pt-4 border-t border-gray-150 flex items-center justify-between">
            <div className="text-[11px] text-[#175D39] bg-[#F2F2F2]/35 border border-amber-300 p-3 rounded-xl flex items-start space-x-1.5 leading-relaxed">
              <AlertTriangle className="w-4 h-4 text-[#175D39] shrink-0 mt-0.5" />
              <span>
